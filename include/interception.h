...
enum InterceptionKeyFilterFlags
{
    INTERCEPTION_KEY_FILTER_NONE             = 0x0000,
    INTERCEPTION_KEY_FILTER_ALL              = 0xFFFF,
    INTERCEPTION_KEY_FILTER_DOWN             = INTERCEPTION_KEY_UP,
    INTERCEPTION_KEY_FILTER_UP               = INTERCEPTION_KEY_UP << 1,
    INTERCEPTION_KEY_FILTER_E0               = INTERCEPTION_KEY_E0 << 1,
    INTERCEPTION_KEY_FILTER_E1               = INTERCEPTION_KEY_E1 << 1,
    INTERCEPTION_KEY_FILTER_TERMSRV_SET_LED  = INTERCEPTION_KEY_TERMSRV_SET_LED << 1,
    INTERCEPTION_KEY_FILTER_TERMSRV_SHADOW   = INTERCEPTION_KEY_TERMSRV_SHADOW << 1,
    INTERCEPTION_KEY_FILTER_TERMSRV_VKPACKET = INTERCEPTION_KEY_TERMSRV_VKPACKET << 1
};
...
enum InterceptionMouseFilterFlags
{
    INTERCEPTION_MOUSE_FILTER_NONE               = 0x0000,
    INTERCEPTION_MOUSE_FILTER_ALL                = 0xFFFF,

    INTERCEPTION_MOUSE_FILTER_LEFT_BUTTON_DOWN   = INTERCEPTION_MOUSE_LEFT_BUTTON_DOWN,
    INTERCEPTION_MOUSE_FILTER_LEFT_BUTTON_UP     = INTERCEPTION_MOUSE_LEFT_BUTTON_UP,
    INTERCEPTION_MOUSE_FILTER_RIGHT_BUTTON_DOWN  = INTERCEPTION_MOUSE_RIGHT_BUTTON_DOWN,
    INTERCEPTION_MOUSE_FILTER_RIGHT_BUTTON_UP    = INTERCEPTION_MOUSE_RIGHT_BUTTON_UP,
    INTERCEPTION_MOUSE_FILTER_MIDDLE_BUTTON_DOWN = INTERCEPTION_MOUSE_MIDDLE_BUTTON_DOWN,
    INTERCEPTION_MOUSE_FILTER_MIDDLE_BUTTON_UP   = INTERCEPTION_MOUSE_MIDDLE_BUTTON_UP,

    INTERCEPTION_MOUSE_FILTER_BUTTON_1_DOWN      = INTERCEPTION_MOUSE_BUTTON_1_DOWN,
    INTERCEPTION_MOUSE_FILTER_BUTTON_1_UP        = INTERCEPTION_MOUSE_BUTTON_1_UP,
    INTERCEPTION_MOUSE_FILTER_BUTTON_2_DOWN      = INTERCEPTION_MOUSE_BUTTON_2_DOWN,
    INTERCEPTION_MOUSE_FILTER_BUTTON_2_UP        = INTERCEPTION_MOUSE_BUTTON_2_UP,
    INTERCEPTION_MOUSE_FILTER_BUTTON_3_DOWN      = INTERCEPTION_MOUSE_BUTTON_3_DOWN,
    INTERCEPTION_MOUSE_FILTER_BUTTON_3_UP        = INTERCEPTION_MOUSE_BUTTON_3_UP,

    INTERCEPTION_MOUSE_FILTER_BUTTON_4_DOWN      = INTERCEPTION_MOUSE_BUTTON_4_DOWN,
    INTERCEPTION_MOUSE_FILTER_BUTTON_4_UP        = INTERCEPTION_MOUSE_BUTTON_4_UP,
    INTERCEPTION_MOUSE_FILTER_BUTTON_5_DOWN      = INTERCEPTION_MOUSE_BUTTON_5_DOWN,
    INTERCEPTION_MOUSE_FILTER_BUTTON_5_UP        = INTERCEPTION_MOUSE_BUTTON_5_UP,

    INTERCEPTION_MOUSE_FILTER_WHEEL              = INTERCEPTION_MOUSE_WHEEL,
    INTERCEPTION_MOUSE_FILTER_HWHEEL             = INTERCEPTION_MOUSE_HWHEEL,

    INTERCEPTION_MOUSE_FILTER_MOVE               = 0x1000
};

enum InterceptionMouseIndicatorFlags
{
    INTERCEPTION_MOUSE_MOVE_RELATIVE      = 0x000,
    INTERCEPTION_MOUSE_MOVE_ABSOLUTE      = 0x001,
    INTERCEPTION_MOUSE_VIRTUAL_DESKTOP    = 0x002,  // the coordinates are mapped to the virtual desktop
    INTERCEPTION_MOUSE_ATTRIBUTES_CHANGED = 0x004,  // requery for mouse attributes
    INTERCEPTION_MOUSE_MOVE_NOCOALESCE    = 0x008,  // do not coalesce WM_MOUSEMOVEs
